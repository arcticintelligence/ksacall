...
<div class="col-xs-5 col-xs-offset-1 dialer-login">
    <ul class="nav nav-justified">
        ...
        <h2>&nbsp;</h2>
        <h2>Android [Google Play Store]</h2>
        <div id="templatemo_dialer" class="templatemo-dialer">
            <div class="content">
                <ul>
                    <li>
                        <a class="external-link" href="<?php echo $file_data_array[3] ?>">
        ...
        <h2>&nbsp;</h2>
        <h2>Android [Direct Download]</h2>
        <div id="templatemo_dialer1" class="templatemo-dialer">
            <div class="content">
                <ul>
                    <li>
                        <a class="external-link" href="<?php echo $file_data_array[4] ?>">
                        <div class="dialer-item-wrapper">
                            <img src="images/android.png">
                        Cyber Asia Platinum
                        </div>
